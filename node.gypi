{
  ...
  'conditions': [
    ...
    [ '(OS=="freebsd" or OS=="linux" or OS=="kos") and node_shared=="false"'
        ' and force_load=="true"', {
      'ldflags': [
        '-Wl,-z,noexecstack',
    ...
    [ 'coverage=="true" and node_shared=="false" and OS in "mac freebsd linux kos"', {
      'cflags!': [ '-O3' ],
      'ldflags': [ '--coverage',
                   '-g',
                   '-O0' ],
        ...
        [ 'node_shared_openssl=="false"', {
          ...
          'conditions': [
            ...
            [ 'force_load=="true"', {
              ...
              'conditions': [
                ['OS in "linux kos freebsd" and node_shared=="false"', {
                  'ldflags': [
                    '-Wl,--whole-archive,'
